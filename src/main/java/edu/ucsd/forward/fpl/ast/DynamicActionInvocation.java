...
/**
 * A dynamic action call AST node, which has a dynamic action path.
 * 
 * @author Michalis Petropoulos
 * 
 */
public class DynamicActionInvocation extends AbstractActionInvocation
{
    @SuppressWarnings("unused")
    private static final Logger log = Logger.getLogger(FunctionNode.class);
    
    private ValueExpression     m_action_path;
     ...
     *            a location.
     */
    public DynamicActionInvocation(HttpVerb verb, Method method, boolean new_window, ValueExpression action_path,
            List<ValueExpression> args, Location location)
    {
     ...
     */
    public ValueExpression getActionPath()
    {
    ...
    public AstNode copy()
    {
        ...
        DynamicActionInvocation copy = new DynamicActionInvocation(this.getHttpVerb(), getMethod(), this.inNewWindow(),
                                                                   (ValueExpression) m_action_path.copy(), copy_args,
                                                                   this.getLocation());
    ...
    public void toActionString(StringBuilder sb, int tabs)
    {
        ...
        m_action_path.toActionString(sb, tabs);
        sb.append("(");
        int count = 0;
