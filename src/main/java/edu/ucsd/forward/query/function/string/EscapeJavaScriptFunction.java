...
/**
 * Escapes JavaScript entities in the input string.
 * 
 * @author Michalis Petropoulos
 * 
 */
public class EscapeJavaScriptFunction extends AbstractStringFunction
{
    @SuppressWarnings("unused")
    private static final Logger log  = Logger.getLogger(EscapeJavaScriptFunction.class);
    
    public static final String  NAME = "escape_javascript";
     ...
     */
    public EscapeJavaScriptFunction()
    {
        super(NAME);
        ...
        signature = new FunctionSignature(FunctionSignatureName.ESCAPE_JAVASCRIPT_STRING.name(), TypeEnum.STRING.get());
    ...
    public BindingValue evaluate(GeneralFunctionCall call, Binding input) throws QueryExecutionException
    {
        ...
        String result = StringEscapeUtils.escapeJavaScript(((StringValue) value).toString());
