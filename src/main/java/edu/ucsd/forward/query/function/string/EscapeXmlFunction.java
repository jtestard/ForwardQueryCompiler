...
/**
 * Escapes XML entities in the input string.
 * 
 * @author Michalis Petropoulos
 * 
 */
public class EscapeXmlFunction extends AbstractStringFunction
{
    @SuppressWarnings("unused")
    private static final Logger log  = Logger.getLogger(EscapeXmlFunction.class);
    
    public static final String  NAME = "escape_xml";
    ...
    public EscapeXmlFunction()
    {
        ...
        signature = new FunctionSignature(FunctionSignatureName.ESCAPE_XML_STRING.name(), TypeEnum.STRING.get());
