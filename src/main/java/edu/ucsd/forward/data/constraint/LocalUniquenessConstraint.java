 ...
 * 
 */
public class LocalUniquenessConstraint extends AbstractConstraint
{
    @SuppressWarnings("unused")
    private static final Logger log = Logger.getLogger(LocalUniquenessConstraint.class);
     ...
     *            - the attributes.
     */
    public LocalUniquenessConstraint(CollectionType relation_type, List<Type> attributes)
    {
